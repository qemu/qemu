...
void QEMU_NORETURN helper_raise_exception_err(CPUMIPSState *env, uint32_t exception,
                                              int error_code)
{
#if 1
    if (exception < 0x100)
...
void QEMU_NORETURN helper_raise_exception(CPUMIPSState *env, uint32_t exception)
{

...
//-AUTOGENERATED BEGIN-
/* invoked from TBA */
int panda_callbacks_insn_exec(CPUState *env, uint64_t pc);
int panda_callbacks_after_insn_exec(CPUState *env, uint64_t pc);
...
void panda_callbacks_replay_hd_transfer(CPUState *env, uint32_t type, uint64_t src_addr, uint64_t dest_addr, size_t num_bytes);
...
bool panda_callbacks_unassigned_io_read(CPUState *env, uint64_t pc, hwaddr addr, size_t size, uint64_t *val);
bool panda_callbacks_unassigned_io_write(CPUState *env, uint64_t pc, hwaddr addr, size_t size, uint64_t val);
...
void panda_callbacks_mmio_after_read(CPUState *env, uint64_t physaddr, uint64_t vaddr, size_t size, uint64_t *val);
void panda_callbacks_mmio_before_write(CPUState *env, uint64_t physaddr, uint64_t vaddr, size_t size, uint64_t *val);
...
void panda_callbacks_replay_serial_receive(CPUState *env, uint64_t fifo_addr, uint8_t value);
void panda_callbacks_replay_serial_read(CPUState *env, uint64_t fifo_addr, uint32_t port_addr, uint8_t value);
void panda_callbacks_replay_serial_send(CPUState *env, uint64_t fifo_addr, uint8_t value);
void panda_callbacks_replay_serial_write(CPUState *env, uint64_t fifo_addr, uint32_t port_addr, uint8_t value);

/* invoked from panda/target/ARCH/translate.c */
bool panda_callbacks_insn_translate(CPUState *env, uint64_t pc);
bool panda_callbacks_after_insn_translate(CPUState *env, uint64_t pc);

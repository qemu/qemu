...
static void tmp105_read(TMP105State *s)
{
    ...
    case TMP105_REG_TEMPERATURE: {
        ...
        int temp_c = rand_byte % 101;  // 0–100 °C
        int16_t temp_fixed = (int16_t)(temp_c * 256);  // Convert to 8.8 fixed-point

        s->temperature = temp_fixed;
...
static void tmp105_reset(I2CSlave *i2c)
{
    ...
    s->alarm = 0;
    s->detect_falling = false;
    s->limit[0] = 0x4b00;  // 75°C
    s->limit[1] = 0x5000;  // 80°C
    tmp105_interrupt_update(s);
}

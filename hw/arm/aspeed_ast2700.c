...
static void aspeed_soc_ast2700_realize(DeviceState *dev, Error **errp)
{
    ...
    /*
     * On the AST2700 LPC subdevice IRQs are connected straight to the GIC.
     *
     * LPC subdevice IRQ sources are offset from 1 because the LPC model caters
     * to the AST2400 and AST2500. SoCs before the AST2700 have one LPC IRQ

...
#define TARGET_DRM_IOCTL_RADEON_CP_INIT    TARGET_DRM_IOW( DRM_COMMAND_BASE + DRM_RADEON_CP_INIT, drm_radeon_init_t)
#define TARGET_DRM_IOCTL_RADEON_CP_START   TARGET_DRM_IO(  DRM_COMMAND_BASE + DRM_RADEON_CP_START)
#define TARGET_DRM_IOCTL_RADEON_CP_STOP    TARGET_DRM_IOW( DRM_COMMAND_BASE + DRM_RADEON_CP_STOP, drm_radeon_cp_stop_t)
#define TARGET_DRM_IOCTL_RADEON_CP_RESET   TARGET_DRM_IO(  DRM_COMMAND_BASE + DRM_RADEON_CP_RESET)
#define TARGET_DRM_IOCTL_RADEON_CP_IDLE    TARGET_DRM_IO(  DRM_COMMAND_BASE + DRM_RADEON_CP_IDLE)
#define TARGET_DRM_IOCTL_RADEON_RESET      TARGET_DRM_IO(  DRM_COMMAND_BASE + DRM_RADEON_RESET)
#define TARGET_DRM_IOCTL_RADEON_FULLSCREEN TARGET_DRM_IOW( DRM_COMMAND_BASE + DRM_RADEON_FULLSCREEN, drm_radeon_fullscreen_t)
#define TARGET_DRM_IOCTL_RADEON_SWAP       TARGET_DRM_IO(  DRM_COMMAND_BASE + DRM_RADEON_SWAP)
#define TARGET_DRM_IOCTL_RADEON_CLEAR      TARGET_DRM_IOW( DRM_COMMAND_BASE + DRM_RADEON_CLEAR, drm_radeon_clear_t)
#define TARGET_DRM_IOCTL_RADEON_VERTEX     TARGET_DRM_IOW( DRM_COMMAND_BASE + DRM_RADEON_VERTEX, drm_radeon_vertex_t)
#define TARGET_DRM_IOCTL_RADEON_INDICES    TARGET_DRM_IOW( DRM_COMMAND_BASE + DRM_RADEON_INDICES, drm_radeon_indices_t)
#define TARGET_DRM_IOCTL_RADEON_STIPPLE    TARGET_DRM_IOW( DRM_COMMAND_BASE + DRM_RADEON_STIPPLE, drm_radeon_stipple_t)
#define TARGET_DRM_IOCTL_RADEON_INDIRECT   TARGET_DRM_IOWR(DRM_COMMAND_BASE + DRM_RADEON_INDIRECT, drm_radeon_indirect_t)
#define TARGET_DRM_IOCTL_RADEON_TEXTURE    TARGET_DRM_IOWR(DRM_COMMAND_BASE + DRM_RADEON_TEXTURE, drm_radeon_texture_t)
#define TARGET_DRM_IOCTL_RADEON_VERTEX2    TARGET_DRM_IOW( DRM_COMMAND_BASE + DRM_RADEON_VERTEX2, drm_radeon_vertex2_t)
#define TARGET_DRM_IOCTL_RADEON_CMDBUF     TARGET_DRM_IOW( DRM_COMMAND_BASE + DRM_RADEON_CMDBUF, drm_radeon_cmd_buffer_t)
#define TARGET_DRM_IOCTL_RADEON_GETPARAM   TARGET_DRM_IOWR(DRM_COMMAND_BASE + DRM_RADEON_GETPARAM, drm_radeon_getparam_t)
#define TARGET_DRM_IOCTL_RADEON_FLIP       TARGET_DRM_IO(  DRM_COMMAND_BASE + DRM_RADEON_FLIP)
#define TARGET_DRM_IOCTL_RADEON_ALLOC      TARGET_DRM_IOWR(DRM_COMMAND_BASE + DRM_RADEON_ALLOC, drm_radeon_mem_alloc_t)
#define TARGET_DRM_IOCTL_RADEON_FREE       TARGET_DRM_IOW( DRM_COMMAND_BASE + DRM_RADEON_FREE, drm_radeon_mem_free_t)
#define TARGET_DRM_IOCTL_RADEON_INIT_HEAP  TARGET_DRM_IOW( DRM_COMMAND_BASE + DRM_RADEON_INIT_HEAP, drm_radeon_mem_init_heap_t)
#define TARGET_DRM_IOCTL_RADEON_IRQ_EMIT   TARGET_DRM_IOWR(DRM_COMMAND_BASE + DRM_RADEON_IRQ_EMIT, drm_radeon_irq_emit_t)
#define TARGET_DRM_IOCTL_RADEON_IRQ_WAIT   TARGET_DRM_IOW( DRM_COMMAND_BASE + DRM_RADEON_IRQ_WAIT, drm_radeon_irq_wait_t)
#define TARGET_DRM_IOCTL_RADEON_CP_RESUME  TARGET_DRM_IO(  DRM_COMMAND_BASE + DRM_RADEON_CP_RESUME)
#define TARGET_DRM_IOCTL_RADEON_SETPARAM   TARGET_DRM_IOW( DRM_COMMAND_BASE + DRM_RADEON_SETPARAM, drm_radeon_setparam_t)
#define TARGET_DRM_IOCTL_RADEON_SURF_ALLOC TARGET_DRM_IOW( DRM_COMMAND_BASE + DRM_RADEON_SURF_ALLOC, drm_radeon_surface_alloc_t)
#define TARGET_DRM_IOCTL_RADEON_SURF_FREE  TARGET_DRM_IOW( DRM_COMMAND_BASE + DRM_RADEON_SURF_FREE, drm_radeon_surface_free_t)

#define TARGET_DRM_IOCTL_RADEON_GEM_INFO    TARGET_DRM_IOWR(DRM_COMMAND_BASE + DRM_RADEON_GEM_INFO, struct drm_radeon_gem_info)
#define TARGET_DRM_IOCTL_RADEON_GEM_CREATE  TARGET_DRM_IOWR(DRM_COMMAND_BASE + DRM_RADEON_GEM_CREATE, struct drm_radeon_gem_create)
#define TARGET_DRM_IOCTL_RADEON_GEM_MMAP    TARGET_DRM_IOWR(DRM_COMMAND_BASE + DRM_RADEON_GEM_MMAP, struct drm_radeon_gem_mmap)
#define TARGET_DRM_IOCTL_RADEON_GEM_PREAD   TARGET_DRM_IOWR(DRM_COMMAND_BASE + DRM_RADEON_GEM_PREAD, struct drm_radeon_gem_pread)
#define TARGET_DRM_IOCTL_RADEON_GEM_PWRITE  TARGET_DRM_IOWR(DRM_COMMAND_BASE + DRM_RADEON_GEM_PWRITE, struct drm_radeon_gem_pwrite)
#define TARGET_DRM_IOCTL_RADEON_GEM_SET_DOMAIN  TARGET_DRM_IOWR(DRM_COMMAND_BASE + DRM_RADEON_GEM_SET_DOMAIN, struct drm_radeon_gem_set_domain)
#define TARGET_DRM_IOCTL_RADEON_GEM_WAIT_IDLE   TARGET_DRM_IOW(DRM_COMMAND_BASE + DRM_RADEON_GEM_WAIT_IDLE, struct drm_radeon_gem_wait_idle)
#define TARGET_DRM_IOCTL_RADEON_CS          TARGET_DRM_IOWR(DRM_COMMAND_BASE + DRM_RADEON_CS, struct drm_radeon_cs)
#define TARGET_DRM_IOCTL_RADEON_INFO        TARGET_DRM_IOWR(DRM_COMMAND_BASE + DRM_RADEON_INFO, struct drm_radeon_info)
#define TARGET_DRM_IOCTL_RADEON_GEM_SET_TILING  TARGET_DRM_IOWR(DRM_COMMAND_BASE + DRM_RADEON_GEM_SET_TILING, struct drm_radeon_gem_set_tiling)
#define TARGET_DRM_IOCTL_RADEON_GEM_GET_TILING  TARGET_DRM_IOWR(DRM_COMMAND_BASE + DRM_RADEON_GEM_GET_TILING, struct drm_radeon_gem_get_tiling)
#define TARGET_DRM_IOCTL_RADEON_GEM_BUSY    TARGET_DRM_IOWR(DRM_COMMAND_BASE + DRM_RADEON_GEM_BUSY, struct drm_radeon_gem_busy)
#define TARGET_DRM_IOCTL_RADEON_GEM_VA      TARGET_DRM_IOWR(DRM_COMMAND_BASE + DRM_RADEON_GEM_VA, struct drm_radeon_gem_va)
#define TARGET_DRM_IOCTL_RADEON_GEM_OP      TARGET_DRM_IOWR(DRM_COMMAND_BASE + DRM_RADEON_GEM_OP, struct drm_radeon_gem_op)
#define TARGET_DRM_IOCTL_RADEON_GEM_USERPTR TARGET_DRM_IOWR(DRM_COMMAND_BASE + DRM_RADEON_GEM_USERPTR, struct drm_radeon_gem_userptr)
